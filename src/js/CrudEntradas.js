const ventt = new Vue({
    ...
    methods:{
            ...
            if (datos.idproductor == 0 ||
                ...
                datos.precio == 0 ) {
                    ...
                    let formData = ventt.toFormData(datos,'insert')
                        axios
                        .post("../controller/entradas_controller.php", formData)
                        .then(response => {
                            if (response.data == "1") {
                              Swal.fire({
                                icon: 'success',
        ...
        searchMonitor: function(){
          ...
          axios.post("../controller/action3.php?action=search", keyword)
            .then(function(response){
              ventt.members = response.data.productores;
