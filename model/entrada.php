...
require('conexion2.php');
    class entrada{
        function insert($idpago,$identrega,$idproductor,$cantidad,$idproducto,$total){
            $connect = new conexion();
            $idestado=1;
            $sql="INSERT INTO `tblentrada`(`idtipopago`,`identrega`,`idproductor`,`cantidad`,`idproducto`,`idestado`,`totalen`)VALUES('$idpago','$identrega','$idproductor','$cantidad','$idproducto','$idestado','$total');";
